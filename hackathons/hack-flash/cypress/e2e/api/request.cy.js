...
describe('Request Fuel Api', () => {
  ...
  it('should be able to request multiple weeks', () => {
    cy.registerFromApi('Car', 'kk-2008')

    cy.request('POST', '/api/fuel/request',
      JSON.stringify({ "licensePlate": "kk-2008", "amount": 20, "date": "2023-04-28T00:00:00.000Z" }))
      .as('fuelRequest1');
    ...
    cy.request('POST', '/api/fuel/request',
      JSON.stringify({ "licensePlate": "kk-2008", "amount": 10, "date": "2023-05-28T00:00:00.000Z" }))
      .as('fuelRequest2');
  ...
  it('should be able to request multiple vehicles', () => {
    cy.registerFromApi('Car', 'kk-2008')
    ...
    cy.request('POST', '/api/fuel/request',
      JSON.stringify({ "licensePlate": "kk-2009", "amount": 20, "date": "2023-05-28T00:00:00.000Z" }))
      .as('fuelRequest2');
